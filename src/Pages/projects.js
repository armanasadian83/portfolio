        ...
        <div className="container">
            <div className="projectPage">
                ...
                <div className='projectBox'>
                    ...
                    <div className="col-12 col-md-4">
                        <div className="item text-center noMarginTop">
                            <img src={vistah} className='w-100' />
                    ...
                    <div className='col-12 col-md-4'>
                        <div className="item text-center">
                            <img src={vistahShop} className='w-100' />
                    ...
                    <div className='col-12 col-md-4'>
                        <div className="item text-center">
                            <img src={nutrinext} className='w-100' />
                ...
                <div className="row projectItems">
                    ...
                    <div className="col-12 col-md-4">
                        <div className="item text-center">
                            <img src={ogenetech} className='w-100' />
                    ...
                    <div className='col-12 col-md-4'>
                        <div className="item text-center">
                            <img src={ogenePanel} className='w-100' />
                    ...
                    <div className='col-12 col-md-4'>
                        <div className="item text-center">
                            <img src={oldVersion} className='w-100' />
                ...
                <div className="row projectItems">
                    ...
                    <div className='col-12 col-md-4'>
                        <div className="item text-center">
                            <img src={newVersion} className='w-100' />
